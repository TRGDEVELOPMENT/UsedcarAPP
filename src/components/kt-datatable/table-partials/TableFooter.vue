<template>
  <div class="row">
    <div class="col-sm-12 col-md-12 d-flex align-items-left justify-content-left">
      <label class="col-form-label fw-semobold fs-6" v-if="itemsPerPageDropdownEnabled" >จำนวนทั้งหมด : {{ count }}</label>
    </div>
