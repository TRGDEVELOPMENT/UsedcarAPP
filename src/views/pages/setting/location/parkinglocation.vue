  ...
  <div>
    <div>
      <ol class="breadcrumb text-muted fs-6 fw-semibold">
        ...
        <li class="breadcrumb-item">
          <span class="">Parking location</span>
        </li>
      </ol>
    </div>
    <div class="p-header">
      <span class="fs-2 fw-bold">Parking location</span>
    </div>
            ...
            <div class="d-flex flex-row">
              <div class="d-flex flex-row flex-column-fluid">
                <div class="d-flex flex-row-fluid flex-left my-5">
                  <span class="fs-5 fw-bold">Parking location</span>
                </div>
...
export default defineComponent({
  ...
  components: {},
  setup() {
    const userrolestore = roleStore();
    let listdatauserrole = ref<RespList<Role[]>>({
      totaldata: 0,
      data: [],
    });
    ...
    const selectdatafinancestatus = ref<Role>({
      id: 0,
      no: 0,
      name: "",
      description: "",
    ...
    const onDelete = async () => {
      ...
      if (resp.value.status) {
        ...
        resp.value = await userrolestore.deleteUserRoleById(
          selectdatafinancestatus.value
        );
        if (resp.value.status) {
          Swal.fire({
