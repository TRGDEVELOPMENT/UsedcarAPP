  ...
  <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    <router-link to="/">
      <img v-if="layout === 'dark-sidebar' ||
        ...
        " alt="Logo" :src="getAssetPath('media/logo/bizcar_l.png')" class="h-40px app-sidebar-logo-default" />
      <img v-if="themeMode === 'light' && layout === 'light-sidebar'" alt="Logo"
        :src="getAssetPath('media/logo/bizcar_l.png')" class="h-25px app-sidebar-logo-default" />
      <img alt="Logo" :src="getAssetPath('media/logo/bizcar_s.png')" class="h-10px app-sidebar-logo-minimize" />
    </router-link>
